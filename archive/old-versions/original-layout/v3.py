...
if not filtered_data.empty:
    ...
    filtered_data['total_emissions'] = (filtered_data['scope_1_emissions'] + filtered_data['scope_2_emissions'] + filtered_data['scope_3_emissions']) * 236_000_000 / 1_000_000_000  # Convert to billions
    filtered_data['monetized_all_scope_emissions'] = filtered_data['total_emissions']
